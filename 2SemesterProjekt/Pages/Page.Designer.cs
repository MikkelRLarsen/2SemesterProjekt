namespace _2SemesterProjekt.Pages
{
    partial class Page
    {
		...
		private void InitializeComponent()
		{
			...
			NavPanel.Location = new Point(1300, 0);
			NavPanel.Margin = new Padding(0);
			NavPanel.Name = "NavPanel";
			NavPanel.Size = new Size(300, 35);
			NavPanel.TabIndex = 0;
			// 
			// MainPanel
			// 
			...
			MedicinNavn.Location = new Point(300, 0);
			...
			SalesNav.Location = new Point(500, 0);
			...
			CustomerNav.Location = new Point(700, 0);
			...
			AdministrationNav.Location = new Point(1100, 0);
			...
			PetNav.Location = new Point(900, 0);
