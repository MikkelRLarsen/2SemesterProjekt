namespace _2SemesterProjekt.Pages.UserControls.MedicineUserControl
{
	partial class FindMedicinPage
	{
		...
		private void InitializeComponent()
		{
			...
			flowPanel.Location = new Point(609, 454);
			flowPanel.Name = "flowPanel";
			flowPanel.Size = new Size(1282, 1027);
			...
			textBoxCustomerPhoneNumberOrName.Location = new Point(845, 357);
			...
			textBoxCustomerPhoneNumberOrName.TabIndex = 45;
			textBoxCustomerPhoneNumberOrName.Text = "Søg på telefonnummer eller navn";
			textBoxCustomerPhoneNumberOrName.Enter += textBoxCustomerPhoneNumberOrName_Enter;
			textBoxCustomerPhoneNumberOrName.Leave += textBoxCustomerPhoneNumberOrName_Leave;
			// 
			// customerSearchButton
			// 
			customerSearchButton.BackColor = Color.AntiqueWhite;
			customerSearchButton.Image = Properties.Resources.SearchButton;
			customerSearchButton.Location = new Point(1323, 361);
			...
			customerSearchButton.TabIndex = 44;
			...
			findAllButton.Location = new Point(1490, 361);
			findAllButton.Name = "findAllButton";
			findAllButton.Size = new Size(165, 35);
			findAllButton.TabIndex = 43;
			...
			label1.Location = new Point(771, 309);
			label1.Name = "label1";
			...
			pictureBox3.Location = new Point(609, 275);
			...
			pictureBox2.Location = new Point(84, 244);
			pictureBox2.Name = "pictureBox2";
			pictureBox2.Size = new Size(2332, 1263);
			...
			label2.Location = new Point(933, 109);
			label2.Name = "label2";
			label2.Size = new Size(635, 81);
			label2.TabIndex = 38;
			label2.Text = "F I N D   M E D I C I N";
			// 
			// pictureBox1
			// 
